...
%\pagenumbering{arabic} % Uncomment this line if you want to renumber pages for each chapter
...
\stepcounter{ex}
\begin{blackBlock}{\textbf{Exercício 4.\arabic{ex}}}\label{tut4:ex:4.7}
